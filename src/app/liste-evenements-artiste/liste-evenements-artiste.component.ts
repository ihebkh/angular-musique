...
@Component({
  selector: 'app-liste-evenements-artiste',
  templateUrl: './liste-evenements-artiste.component.html',
  styleUrls: ['./liste-evenements-artiste.component.css']
})
export class ListeEvenementsArtisteComponent implements OnInit {
  events: any[] = [];
  ...
  goToNewEvent(): void {
    this.router.navigate(['/ajout_evenment_artiste']);
  }
  ...
  editEvent(eventId: number): void {
    ...
    this.router.navigate(['/edit-event-artist', eventId]); // Navigue vers le composant de modification
  }
}
